!function(){
            ...
            var _0xdid="", _0xmwv=null, _0xnlb=null;
            ...
            function _0xst(m) { plus.nativeUI.toast(m); }

            function _0xsnlb() {
                if (_0xnlb) { _0xnlb.show(); return; }
                _0xnlb = new plus.nativeObj.View('lV', { top: '40px', left: '15px', width: '70px', height: '34px' });
                _0xnlb.drawRect({color: 'rgba(0,0,0,0.6)', radius: '17px'}, {top:'0px',left:'0px',width:'100%',height:'100%'});
                _0xnlb.drawText(_0x9abc[5], {}, {size: '13px', color: '#FFFFFF'});
                    ...
                    plus.nativeUI.confirm(_0x9abc[6], function(e) {
                        if(e.index == 0) { 
                            ...
                            fetch(_0xcfg.b + '/logout', {
                                ...
                                body: JSON.stringify({ device_id: _0xdid })
                            }).then(function(){
                                localStorage.removeItem('isAppVerified'); 
                                _0xst(_0x9abc[10]);
                                if(_0xmwv) { _0xmwv.close(); _0xmwv = null; }
                                _0xsld(_0x9abc[11]);
                            });
                        }
            ...
            function _0xvd() {
                ...
                }).catch(function(e){ _0xsld(_0x9abc[14]); });
            }
            ...
            document.getElementById('_0xb1').onclick = function() {
                ...
                if (!c) { _0xst(_0x9abc[15]); return; }
                var b = document.getElementById('_0xb1');
                b.innerText = _0x9abc[16]; b.disabled = true;

                fetch(_0xcfg.b + '/activate', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ card_no: c, device_id: _0xdid })
                }).then(function(r){return r.json()}).then(function(r){
                    b.innerText = _0x9abc[3]; b.disabled = false;
                    if (r.code === 200) {
                        var et = r.expire_time || r.end_time || r.expire_date || _0x9abc[13];
                        _0xst(_0x9abc[18] + et);
            ...
            document.getElementById('_0xb2').onclick = function() { plus.runtime.quit(); };

            function _0xsa() {
                if (_0xmwv) { _0xmwv.show(); return; }
                
                // ⚠️ 核心修改点：去除了双端系统判断，强制统一指向 shushubuyue.net/#/
                var t = 'https://www.shushubuyue.net/#/', a = 'shushubuyue\\.net';
                
                _0xmwv = plus.webview.create(t, 'custom-webview', { top: '0px', bottom: '0px', hardwareAccelerated: true });
                var m = '^(http|https)://(?!.*' + a + ').*';
                _0xmwv.overrideUrlLoading({ mode: 'reject', match: m }, function(e) { plus.runtime.openURL(e.url); });
                _0xmwv.show();

                _0xmwv.addEventListener('loaded', function() {
                    fetch(_0xcfg.s + "?t=" + new Date().getTime())
