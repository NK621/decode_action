//Wed Apr 23 2025 02:25:59 GMT+0000 (Coordinated Universal Time)
...
MainFunc = () => {
  function _0x1a8d9a() {
          ...
          case "PAIRED":
            {
              ...
              if (_0x563b95 == chatPage.MatchWho) {
                if (justonce) {
                  ...
                  $.toast("å·²åŒ¹é…åˆ°" + chatPage.MatchWho + "并发送信息！", 800);
                  justonce = false;
                }
                break;
              }
    ...
    function _0x59c9af() {
      ...
      chatPage.MatchWho = _0x2c6dec ? "å¥³ç”Ÿ" : "ç”·ç”Ÿ";
      $("#txt_match")[0].innerText = "ä»…" + chatPage.MatchWho;
    }
    function _0x38eb20() {
      try {
    ...
    setTimeout(() => {
      {
        ...
        _0x3c78a2("å¬è¯´å†…ç¾¤ä¸“å±žï¼Œç”µæŠ¥é¢‘道@bdsm368\r\n从倒卖者处获取插件导致无法使用我们概ä¸è´Ÿè´£");
      }
    }, 3);
  }
  try {
