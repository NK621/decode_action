//Wed Jan 28 2026 01:12:21 GMT+0000 (Coordinated Universal Time)
...
const chatPage = {
  ...
  getPartnerInfo() {
    ...
    return {
      gender: _0x28f147.gender || "未知",
      age: _0x28f147.age == 1 ? "18岁以下" : _0x28f147.age == 2 ? "18-23岁" : "23岁以上",
      province: _0x28f147.province || "未知",
  ...
  normalizeBlacklistItem(_0x3d6cdd) {
    ...
    return {
      ...
      gender: _0x3d6cdd.gender || "未知",
      age: _0x3d6cdd.age || "未知",
      province: _0x3d6cdd.province || "未知",
  ...
  showImportDialog() {
    ...
    _0x2ae2e0.innerHTML = "\n            <div class=\"confirm-header\">\n                <div class=\"confirm-title\">导入黑名单</div>\n            </div>\n            <div class=\"confirm-body\">\n                <div class=\"confirm-message\">请粘贴黑名单JSON数据：</div>\n                <textarea class=\"import-textarea\" id=\"importTextarea\" placeholder=\"在此粘贴黑名单JSON数据...\"></textarea>\n            </div>\n            <div class=\"confirm-footer\">\n                <button class=\"confirm-btn confirm-btn-cancel\" id=\"importCancel\">取消</button>\n                <button class=\"confirm-btn confirm-btn-primary\" id=\"importOk\">导入</button>\n            </div>\n        ";
      ...
      try {
        {
          ...
          if (!Array.isArray(_0x3537b2)) {
            {
              this.showToast("数据格式错误：必须是数组格式", "error");
              return;
            }
          }
          ...
          _0x5eb50c.length > 0 ? this.showToast("成功导入 " + _0x5eb50c.length + " 条黑名单", "success") : this.showToast("没有新的黑名单数据（可能已存在）", "info");
        }
      } catch (_0x291338) {
          ...
          try {
            {
              ...
              if (!Array.isArray(_0x5666bc)) {
                this.showToast("剪切板格式错误：必须是数组格式", "error");
                return;
              }
              ...
              this.refreshBlacklistList();
              this.showToast("成功导入 " + _0x236d3c.length + " 条黑名单", "success");
            }
          } catch (_0x9f3b96) {
            {
              this.showToast("剪切板解析失败：" + _0x9f3b96.message, "error");
            }
          }
        }
      }).catch(_0x3c7df8 => {
        ...
        try {
          if (document.execCommand("paste")) {
            ...
            try {
              ...
              this.showToast("剪切板解析失败：" + _0x10302a.message, "error");
            }
          } else {
            this.showToast("读取剪切板失败", "error");
          }
    ...
    return new Promise((_0xd6c228, _0x2e324d) => {
      ...
      _0x4e96c7.onload = _0x3b1b91 => {
        try {
          ...
          {
            _0x2e324d(new Error("文件解析失败：" + _0x3a1b9c.message));
          }
        }
      };
      _0x4e96c7.onerror = () => {
    ...
    try {
      {
        ...
        if (typeof _0x42dcf1 === "string") {
          ...
          if (Array.isArray(_0x42dcf1)) {
            ...
            throw new Error("数据格式错误：必须是数组或JSON字符串");
          }
        }
  ...
  blockUser() {
    try {
      ...
      this.showConfirm({
        ...
        _0x51e475.confirmed && (this.addToBlacklist(_0x3c1e42, _0x51e475.remark || ""), console.log("拉黑用户:", _0x3c1e42));
      });
    } catch (_0xc26cc5) {
      console.error("拉黑用户失败:", _0xc26cc5);
  ...
  showBlacklistPanel() {
    ...
    document.getElementById("blacklistClearBtn").addEventListener("click", () => {
      this.showConfirm({
        title: "清空黑名单",
        message: "确定要清空所有黑名单记录吗？此操作不可恢复。",
        confirmText: "清空",
        cancelText: "取消",
        confirmType: "delete"
      }).then(_0x46950e => {
        _0x46950e.confirmed && (this.saveBlacklist([]), this.refreshBlacklistList(), this.showToast("已清空黑名单", "success"));
      });
    });
  ...
  handleAddBlacklist() {
    ...
    if (!_0x19e726 || !_0x19e726.partnerIdEncrypted) {
      {
        this.showToast("未获取到当前用户，无法添加", "warning");
        return;
      }
    }
    this.updateCurrentPartnerIdDisplay();
  ...
  refreshBlacklistList() {
    ...
    _0x5b228e && (_0x5b228e.textContent = _0x2545a5.length + " 人");
  ...
  initialize() {
    ...
    function _0xfac3e6(_0x477d68, _0x1e11aa = "info", _0x424393 = 4000) {
      {
        ...
        _0x3a2cc4.innerHTML = "\n                <span class=\"toast-icon\">" + (_0x5884be[_0x1e11aa] || "ℹ️") + "</span>\n                <span>" + _0x477d68 + "</span>\n            ";
    ...
    document.getElementById("ckb_script").addEventListener("change", function () {
      {
        const _0x249b60 = this.checked ? "开启" : "关闭";
        chatPage.scriptRunning = this.checked;
        _0xfac3e6("脚本" + _0x249b60, this.checked ? "success" : "info");
        console.log("脚本启动: " + _0x249b60);
      }
    });
    document.getElementById("ckb_match").addEventListener("change", function () {
      const _0x41b9e2 = this.checked ? "女生" : "男生";
      document.getElementById("txt_match").textContent = "仅" + _0x41b9e2;
